  ...
  return (
    <Fragment>
      <div className="bg-slate-50 overflow-x-hidden">
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                  ...
                  <div className="flex flex-col justify-between items-center md:items-start lg:items-start">
                    ...
                    <p className="text-[13px] md:text-base lg:text-base">
                      <span className="font-semibold">150+</span> happy
                      customers
                    </p>
                  </div>
                </div>
        ...
        <section className="bg-gradient-to-b from-red-50 to-red-300 py-24">
            ...
            <div className="mx-auto grid max-w-xl grid-cols-1 px-2 md:max-w-2xl lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-12 md:gap-y-16">
              <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                ...
                <div className="text-[13px] md:text-lg leading-7 md:leading-8 lg:text-lg lg:leading-8">
                  <p>
                    "We love our crewnecks, so soft and comfy its hard to not
                    wear it everyday. And the whole{" "}
                ...
                <div className="flex gap-4 -mt-2 md:mt-2 lg:mt-2 ">
                  <img
                    className="rounded-full h-10 w-10 md:h-12 md:w-12 lg:h-12 lg:w-12 object-cover bg-white"
                    src="/users/akpsi.png"
                    alt="user"
                  />
              ...
              <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                ...
                <div className="flex gap-4 -mt-2 md:mt-2 lg:mt-2">
                  <img
                    className="rounded-full h-10 w-10 md:h-12 md:w-12 object-cover bg-white"
                    src="/users/pike.png"
                    alt="user"
                  />
                  <div className="flex flex-col -ml-2 md:ml lg:ml">
          ...
          <div className="flex justify-center items-center -mt-28 md:-mt-12 lg:-mt-12">
            <LogoScroll />
          </div>
        </section>
        <section className="bg-slate-50 grainy-dark py-24">
          <MaxWidthWrapper className="flex flex-col gap-16 sm:gap-32">
            <div className="flex flex-col lg:flex-row lg:items-start w-full">
              <div className="text-center lg:text-left w-full lg:w-2/3 lg:pr-16">
